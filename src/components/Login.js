  ...
  return (
    <div>
      ...
      <form
        ...
        className="absolute md:w-3/12 p-8 md:p-10 my-28 md:my-40 mx-12 sm:mx-24 md:mx-auto right-0 left-0 bg-black text-white rounded-lg bg-opacity-80"
      >
        <h1 className="font-bold text-xl md:text-2xl py-0 md:py-4">
